                                ...
                                <div class="padding_eight_all bg-white">
                                    ...
                                    <form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="name" placeholder="Name" required autocomplete="name" autofocus value="{{old('name')}}">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="email" placeholder="Email" required autocomplete="email" autofocus value="{{old('email')}}">
                                        </div>
                                        <div class="form-group">
