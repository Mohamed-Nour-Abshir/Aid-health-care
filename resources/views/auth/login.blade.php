							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" action="{{route('login')}}" method="POST">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-login-uname" name="email" placeholder="Enter your email address" value="{{old('email')}}" required autocomplete="email">
									</fieldset>
									<fieldset class="wrap-input">
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form action="{{route('login')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="email" placeholder="Your Email" value="{{old('email')}}" required autocomplete="email">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="text-muted text-center">I don't have account <a href="{{route('register')}}">Sign up now</a></div>
                                    </div>
                                </div>
                            </div>
