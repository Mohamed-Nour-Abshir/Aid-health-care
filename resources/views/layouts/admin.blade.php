  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        {{-- <a class="navbar-brand brand-logo mr-5" href="{{route('admin.dashboard')}}"><h1>Landing</h1></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('admin.dashboard')}}">Landing</a> --}}
        <a class="navbar-brand brand-logo mr-5" href="{{route('admin.dashboard')}}"><img src="{{asset('assets/imgs/logo/2.png')}}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('admin.dashboard')}}"><img src="{{asset('assets/imgs/logo/2.png')}}" alt="logo"/></a>
      </div>
        ...
        <div class="content-wrapper">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                  <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo date("Y");?>. <span class="text-primary">Aid Health Care </span> All rights reserved.</span>
                </div>
            </footer>
        </div>
      </div>
