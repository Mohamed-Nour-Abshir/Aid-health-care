            ...
            <form wire:submit.prevent="placeOrder" onsubmit="$('#processing').show();">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                <p class="row-in-form">
                                    ...
                                    <input type="text" id="frm-reg-lname" placeholder="Enter Full Name*" required autocomplete="name" autofocus value="{{old('name')}}" wire:model.lazy="name">
                                </p>

                                <p class="row-in-form">
                                    <label for="frm-reg-email">Email Address*</label>
                                    <input type="email" id="frm-reg-email"  placeholder="Email address" required autocomplete="email" autofocus value="{{old('email')}}" wire:model.lazy="email">
                                </p>
                                <p class="row-in-form">
                                </p>
                                <p class="wrap-title">
                                    <p class="row-in-form">
                                        ...
                                        <input type="password" id="frm-reg-email" placeholder="New Password" required autocomplete="new-password" wire:model.lazy="password">
                                    </p>
                                    <p class="row-in-form ">
                                        <label for="frm-reg-cfpass">Confirm Password *</label>
                                        <input type="password" id="frm-reg-email" placeholder="Confirm New Password" required autocomplete="new-password" wire:model.lazy="password_confirmation">
                                    </p>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="add1" value="" placeholder="Street at apartment number" wire:model="line1">
                                    @error('line1') <span class="text-danger"> {{$message}}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add">Address 2:</label>
                                    <input type="text" name="add2" value="" placeholder="Street at apartment number" wire:model="line2">
                                </p>
                                <p class="row-in-form">
                                    <label for="country">Country</label>
                                    <input type="text" name="country"placeholder="Bangladesh" value="Bangladesh" wire:model="country">
                                    @error('country') <span class="text-danger"> {{$message}}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="city">Thana/Police station<span>*</span></label>
                                    <input type="text" name="province" value="" placeholder="Thana/Police station" wire:model="province">
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="add">Address 1:</label>
                                        <input type="text" name="add1" value="" placeholder="Street at apartment number" wire:model="s_line1">
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <label class="payment-method">
                                ...
                                <span class="payment-desc">01875196278</span>
                                <span class="payment-desc"> Pleae send this number that amount of money </span>
                            </label>
                            @error('paymentmode') <span class="text-danger"> {{$message}}</span> @enderror
                        </div>
                        @if (Session::has('checkout'))
                          <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price"><span class="text-danger">&#2547;</span> {{Session::get('checkout')['total']}}</span></p>
                        @endif
                    ...
                    <div class="summary-item shipping-method">
                        ...
                        <p class="summary-info"><span class="title" ></span>
                            <table class="table table-bordered">
                                <tr>
                                    <td>60BDT inside Dhaka </td>
                                    <td>100BDT Outside Dhaka </td>
                                </tr>
                            </table></span></p>
                    </div>
                </div>
