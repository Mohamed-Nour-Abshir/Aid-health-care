                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="addProduct" class="forms-sample" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div>
                                <textarea type="text" class="form-control input-md" rows="5" placeholder="Short Description" wire:model="short_description"></textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div>
                                <textarea type="text" class="form-control input-md" rows="10" cols="30" placeholder="Description" wire:model="description"></textarea>
