                   ...
                   <div class="card-body">
                    ...
                    <div class="summary">
                        <div class="order-summary">
                            ...
                            <p class="summary-info"><span class="title">Delivery charge</span><b class="index">{{$order->tax}}</b> </p>
                            
                            <p class="summary-info"><span class="title">Total</span><b class="index">{{$order->total}} <span class="text-danger">BDT</span></b></p>
                        </div>
                    </div>
                   </div>
               </div>
