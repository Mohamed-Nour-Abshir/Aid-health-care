                                    ...
                                    <div class="detail-gallery" wire:ignore>
                                        ...
                                        {{-- <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            @foreach ($images as $image)
                                                <div><img src="{{asset('assets/images/products')}}/{{$image}}" alt="product image"></div>
                                            @endforeach
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            <div class="detail-qty border radius">
                                                ...
                                                <input type="text" name="product-quatity" class="qty-val" value="1" data-max="120" pattern="[0-9]*" wire:model="qty">
                                                            ...
                                                            <div class="single-comment justify-content-between d-flex">
                                                                <div class="user justify-content-between d-flex">
                                                                    <div class="thumb text-center">
                                                                        <img src="@if($orderItem->order->user->profile){{asset('assets/images/profile')}}/{{$orderItem->order->user->profile->image}} @else {{asset('assets/images/profile/default.png')}} @endif " alt="{{$orderItem->order->user->name}}">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($popular_products as $p_products)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{asset('assets/images/products')}}/{{$p_products->image}}" alt="#">
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a href="{{route('product.details',['slug'=>$p_products->slug])}}">{{$p_products->name}}</a></h5>
                                        <p class="price mb-0 mt-5">৳{{$p_products->sale_price}}</p>
